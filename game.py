...
class Game:
    ...
    def __init__(self, player_type):
        ...
        self.permanentAgentRL = ag.Qlearning(self.screen_height, self.bar_height, 0.5, 0.9,0.01)
        if self.player_type == 'agentRL':
            self.agentRL = ag.Qlearning(self.screen_height, self.bar_height, 0.5, 0.9,0.01)
    ...
    def play(self):
        ...
        while True:
            ...
            # si le choix est  AgentRL vs Human

            if self.player_type == 'human':
                self.animation_human()
                # si le choix est AgentRL vs AgentAI
            elif self.player_type == 'agentAI':
                self.animation_agentAi()
           
             # si le choix est  AgentRL vs AgentRL
